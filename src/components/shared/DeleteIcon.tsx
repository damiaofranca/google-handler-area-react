...
/**
 * Small trash-can glyph used by the map "delete area" control.
 *
 * @internal
 */
export const DeleteIcon: React.FC = () => (
    <svg width="24" height="24" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path
